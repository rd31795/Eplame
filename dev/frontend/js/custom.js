...
$(document).ready(function() { 
  ...
  $("#closeUpcomSidebar").click(function(){
    $("#UserUpcmStatus").removeClass("show-sidebar");
});
  });
...
//sidebar toggle
$(document).ready(function() { 
  $("#calender-toggle").click(function(){
      $("#weather-sidebar").addClass("show-sidebar");
      });
  $("#calendarSidebar-close").click(function(){
    $("#weather-sidebar").removeClass("show-sidebar");
   });
  });
