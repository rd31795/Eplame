...
<div class="row">
  ...
  <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 img-row">
    ...
    <?php $item_url = url('/').'/wedding_app/public/photos'.$working_dir.'/'.$item->name ?>
    <?php $thumb_src = url('/').'/wedding_app/public/photos'.$working_dir.'/thumbs/'.$item->name ?>
    <?php $item_path = $item->is_file ? $item_url : $item->path; ?>
