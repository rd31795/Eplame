<header class="site-header">
   ...
   <div class="top-bar">
      <div class="container">
         <div class="top-menus-wrap">
            <button class="menu-toggle" type="button" data-step="1" data-intro="You can access the informational pages from here.">
   ...
   <div class="header-links-wrap">
      <div class="container">
         <ul class="head-links {{ Auth::check() ? 'userLoggedIn' : ''}}" data-step="2" data-intro="You can find the business listings, login, register and your dashboard here.">
            ...
            <li class="mob-hide"><a href="{{url(route('vendor_register'))}}">New Vendor</a></li>
             <li class="mob-hide"><a href="{{url(route('shop.index'))}}">Shop</a></li>
      ...
      <div class="container">
         <ul id="menus-list" class="menu-list">
            ...
            <li>
               ...
               style="background:url({{url('/frontend/images/menu-faq.png')}})">
            ...
            <li>
               <a href="{{url(route('shop.index'))}}" style="background:url({{url('/frontend/images/menu-sign.png')}})">
                  <span class="nav-item-icon"><i class="fas fa-star"></i></span>
                  <h3>Shop</h3>
               </a>
            </li>
