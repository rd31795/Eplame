    ...
    <form id="BusinessListingFilter" action="{{url(route('get_all_businesses'))}}">
                        <div id="accordion">
                            <div class="card">
                                ...
                                @endif
                                 @if(Request::has('games') && !empty(Request::get('games')))
                                     
                                     @foreach(Request::get('games') as $g)
                                        <input type="hidden" name="games[]" value="{{$g}}">
                                ...
                                @if(Request::has('vendor') && !empty(Request::get('vendor')))
                                     ...
                                     @foreach(Request::get('vendor') as $vv)
                                        <input type="hidden" name="vendor[]" value="{{$vv}}">
                                 ...
                                 @foreach($categories as $category)
                                     <div class="card-body listing sub-head">
                                         <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input businesses main-category" name="vendors[]" id="customCheck{{$category->id}}" value="{{$category->id}}"
                                   ...
                                   @foreach($category->subcategory as $subcategory)
                                     ...
                                     <div class="card-body listing">
                                          ...
                                          <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input businesses sub-category customCheck{{$category->id}}" data-id="customCheck{{$category->id}}" name="vendors[]" value="{{$subcategory->id}}" id="customCheck{{$subcategory->id}}"  >
                                ...
                                <div id="collapseTwo" class="collapse" data-parent="#accordion">
                                    <div class="card-body listing">
                                        <div class="form-group">
                                            <input type="date" id="availability" class="form-control available" placeholder="Select Date">
