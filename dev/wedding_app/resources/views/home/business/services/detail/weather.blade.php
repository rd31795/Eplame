    ...
    <div class="weather-info-wrapper">
      ...
      <div class="info-weather">
        <div class="weather-wrapper">
          ...
          <div class="weather-sunny"><img id="main-icon" src="{{url('/')}}/dev/frontend/DarkSky-icons/SVG/clear-day.svg"></div>
        </div>        
                        ...
                        <div class="weather-data d-flex">
                            <div class="mr-auto">
                               <div class="weather-status d-f a-i-c">
                                <span class="weather-status-icon"><img id="modal-main-icon" src="{{url('/')}}/dev/frontend/DarkSky-icons/SVG/clear-day.svg"></span><h4 class="display-3" id="modal-mainTemperature"></h4>
                              </div>
