...
<a data-toggle="modal" data-target="#weatherModal" id="open_weather_modal" style="opacity: 0;" href="javascript:void(0);">
  ...
  <div class="weather-info" style="background-image: url({{url('/')}}/frontend/images/weather.png)">
    <div class="weather-info-wrapper">
      ...
      <div class="info-weather">
        <div class="weather-wrapper">
          ...
          <div class="weather-sunny"><img id="main-icons" src="{{url('/')}}/frontend/DarkSky-icons/SVG/clear-day.svg"></div>
        </div>        
                        ...
                        <div class="weather-data d-flex">
                            <div class="mr-auto">
                               <div class="weather-status d-f a-i-c">
                                <span class="weather-status-icon"><img id="modal-main-icons" src="{{url('/')}}/dev/frontend/DarkSky-icons/SVG/clear-day.svg"></span><h4 class="display-3" id="modal-mainTemperature"></h4>
                              </div>
