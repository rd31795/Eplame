                                            ...
                                            @foreach($videos as $video)
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                    <div class="outer-wrap">
                                                        ...
                                                        <a class="cstm-modal-anc" href="" data-toggle="modal" data-target="#exampleModal" data-src="{{ $video->path }}" data-title="{{ $video->title }}" data-description="{{ $video->description }}" data-user_pic="{{ $src }}" data-user_name="{{ $video->discussionFileUserId->first_name }}" data-upload_date="{{ $video->updated_at }}"><h5>{{ $video->title }}</h5></a>
