        ...
        <div class="sec-card">
          ...
          <!--  Category Management block -->
            <div class="checklist-wrap bugdet-page">
               <form class="discussion-card" name="createDiscussion" id="createDiscussionForm" method="post" action="{{ route('forum.video.store') }}">
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                           <input type="text" name="video_url" placeholder="Enter Youtube Video URL..." class="form-control">
                        </div>
                    </div>
