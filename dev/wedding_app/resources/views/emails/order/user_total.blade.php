                                                      ...
                                                      <tbody>
                                                       ...
                                                       @endif  
                                                        ...
                                                        <?php $extra = getOrderExtraFees($order);
                                                         $total = $order->sum('discounted_price') + ($extra['tax'] + $extra['service']);
                                                        ?>
                                                         ...
                                                         @if($order->sum('discount') > 0)
                                                           <tr>
                                                               <td colspan="2">
                                                                  <p style="font-size: 17px; font-family: Verdana, 'Times New Roman', Arial;">You will save <strong>${{custom_format($order->sum('discount'),2)}} </strong>on this order.</p>
                                                               </td>
                                                           </tr>
                                                        @endif
                                                      </tbody>
