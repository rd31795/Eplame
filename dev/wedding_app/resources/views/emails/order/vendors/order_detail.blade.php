                                          ...
                                          <table align="center" cellpadding="0" cellspacing="0" width="100%" style= "border-collapse: collapse;">
                                             <tbody>
                                                <tr>
                                                   ...
                                                   <td style="font-family: Verdana, 'Times New Roman', Arial; font-size: 14px; line-height: 18px; color: #0c0c0c; padding-top: 10px; padding-bottom: 10px; font-weight: 600; background-color: #efefef; padding-left: 10px; padding-right: 10px;width:200px;" align="left">Package</td>
                                                   <td style="font-family: Verdana, 'Times New Roman', Arial; font-size: 14px; line-height: 18px; color: #0c0c0c; padding-top: 10px; padding-bottom: 10px; font-weight: 600; background-color: #efefef; padding-left: 10px; padding-right: 10px;width:100px;" align="left">Addons</td>
...
@foreach($order as $item)
      ...
      <tr>
         ...
         <td align="top" style="font-family: Verdana, 'Times New Roman', Arial; vertical-align: top; font-size: 16px; font-weight: bold; line-height: 22px; color: #0c0c0c; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">


                              <?php  $arr =getOrderExtraFeess($item) ?>
                             ...
                             <table class="cart-table margin-top-5">
                                  <tbody>
                                          ...
                                          <tr class="price-row">
                                             <th>Website Fee</th>
                                             <td><strong>${{ custom_format($arr['commission'],2) }}</strong></td>
                                          </tr>

                                           <tr class="price-row">
                                             <th>Service Fee</th>
                                             <td><strong>${{ custom_format($arr['service'],2) }}</strong></td>
                                          </tr>

                                          <tr class="price-row">
                                             <th>Total Price</th>
                                             <td><strong>${{ custom_format($arr['payable'],2) }}</strong></td>
                                          </tr>
                                  </tbody>
                             </table>
