...
<div class="col-md-6" >
                        ...
                        <div class="form-group" >
                                ...
                                <select class="form-control" name="featured">
                                  <option value="0" {{$category->featured == 0 ? 'selected' : ''}}>Featured</option>
                                  <option value="1" {{$category->featured == 1 ? 'selected' : ''}}>Unfeatured</option>
                                </select>
                        </div>
</div>
...
<div class="col-md-4">
    {{textbox($errors, 'Escrow Percentage', 'escrow_percentage', $category->escrow_percentage)}}
</div>
