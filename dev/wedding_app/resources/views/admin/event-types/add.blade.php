...
<div class="col-md-12">
  ...
  <form role="form" method="post" id="eventForm" action="{{url(route('store_events'))}}" enctype="multipart/form-data">
                  ...
                  <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" name="type" id="corp-2" value="corporate" checked>
                            <label class="custom-control-label" for="corp-2">Corporate</label>
                          </div>

                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" name="type" id="priv-2" value="private">
