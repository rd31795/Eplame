                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header status-btns">
                                            ...
                                            <div>
                                <button type="button" onclick="getBusinesses(2)" class="btn btn-warning"><i class="fas fa-eye"></i>View Pending</button>
                                <button type="button" onclick="getBusinesses(3)" class="btn btn-success"><i class="fas fa-eye"></i>View Approved</button>
                                <button type="button" onclick="getBusinesses(4)" class="btn btn-danger"><i class="fas fa-eye"></i>View Rejected</button>
                                <button type="button" onclick="getBusinesses(5)" class="btn btn-danger"><i class="fas fa-eye"></i>View Blocked</button>
                            </div>
                                        </div>
...
$('#example2').DataTable({
    ...
    processing: true,
    serverSide: true,
    ajax: `/dev/admin/businesses/ajax_getBusinesses/${status}`,
    columns: [
