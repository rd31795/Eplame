    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav ml-auto">
                @php
                $mode=DB::table('maintenance')->first();
                @endphp
                Maintenance Mode : <a href="{{route('manage_maintenance')}}" class="btn {{$mode->maintenance_mode==1?'btn-danger':'btn-success'}} btn-sm">{{$mode->maintenance_mode==1?'ON':'OFF'}} </a>
                <!-- <li>
                    <div class="dropdown">
