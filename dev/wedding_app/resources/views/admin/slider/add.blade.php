    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <div class="col-md-12">
              <form  method="post" action="{{route('admin.slider.create')}}" id="SliderBannerForm" enctype="multipart/form-data" >
                  @csrf
              <div class="row" style="width:100%;">
               ...
               <div class="col-md-12">
               <img src="" id="image_src" style="width: 100%; height: 300px; display: none";
               />
                 <div class="form-group">
               ...
               <input type="file" accept="image/*" id="banner_image" onchange="ValidateSingleInput(this, 'image_src')"   class="form-control" name="banner_image">
                  ...
                  <div class="card-footer">
                    <button type="submit" id="SliderFormBtn" class="btn btn-primary">Create</button>
                  </div>
             </form>
            </div>
          </div>
