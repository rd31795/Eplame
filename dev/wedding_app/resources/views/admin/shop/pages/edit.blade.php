        ...
        @include('admin.error_message')
            ...
            <div class="card-body">
              <form role="form" method="post" id="BrandForm" enctype="multipart/form-data">
                @csrf
                  {{textbox($errors, 'Page Title*', 'title',$shop_pages->title)}}                          
                  {{textarea($errors, 'Page Content*', 'content',$shop_pages->description)}}                          
                  <div class="card-footer">
                    <button type="submit" id="BrandFormBtn" class="btn btn-primary">Update</button>
                  </div>
             </form>
            </div>
            <!-- /.card-body -->
