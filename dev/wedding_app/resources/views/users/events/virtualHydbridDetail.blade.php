        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-2">
                <div class="btn-wrap text-right mb-3">
                    <a href="@if(Auth::user()->id == $user_event->user_id) {{ route('user_show_edit_virtual_hybrid_event', $user_event->slug) }} @else {{ route('user_show_edit_co_event', $user_event->slug) }} @endif" class="cstm-btn edit-event-btn">Edit Event</a>
                </div>
            </div>
            @endif
            @if($userGuest == '')
        ...
        <div class="main-header__intro-wrapper">
            ...
            <div class="quickview">
                <div class="quickview__item">
                    <div class="quickview__item-total">{{ Auth::user()->UpcomingUserEvents->where('event_status', 1)->count() }}</div>
                                ...
                                <div class="event-detail-full-dec">
                                    ...
                                    <div class="evnt-full-detail">
                                        ...
                                        <ul class="evt-more-dec">
                                            ...
                                            <li> @if($min == $max)
                                                <p class="evt-more-deatil"> <span class="icon"><i class="fas fa-dollar-sign"></i></span>@if(empty($min)) FREE @else $min @endif</span></p>
                                                @elseif($min != $max)
                                                <p class="evt-more-deatil"> <span class="icon"><i class="fas fa-dollar-sign"></i></span> ${{$min}} - ${{$max}}</span></p>
                                                @else
                                                <p class="evt-more-deatil"> <span class="icon"><i class="fas fa-dollar-sign"></i></span>Free</span></p>
                                                @endif
                                            </li>
                                            <li>
                                                <p><span class="icon"><i class="fas fa-video"></i></span>
                                                    @if($user_event->start_date <= \Carbon\Carbon::today())
                                                    <a href="{{ $user_event->zoom_url }}" class="cstm-btn zoom-btn" target="_blank"> Link</a>
                                                    @else
                                                    <a href="javascript:void(0)" class="cstm-btn zoom-btn">Link</a>(Not Available)
                                                    @endif
            ...
            <div class="card">
                <div class="card-block">
                    <div class="event-card-head j-c-s-b">
                        <div class="event-card-head-new">
                            <button href="#collapse" class="nav-toggle cls-hide-show"><i class="fas fa-minus"></i></button>
                            <h3>Tickets</h3>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                            <div class="ticket-card">
                                ...
                                <br>
                                <div class="ticket-card-2 d-flex">
                                    <div class="cs-left" style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS87NtVxiDIrh_kqyHIWkLT8qboJvEHpFuHjQ&usqp=CAU');">
                                        <h6>Lorem ipsum</h6>
                                        <h2>SPORT EVENT</h2>
                                        ...
                                        <div class="cs-rows-wrapper">
                                            <ul class="d-flex flex-wrap align-items-center">
                                                <li>
                                                    <div class="cs-card">
                                                        <p><span class="cs-yellow">ROW</span> <strong>01</strong> </p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="cs-card">
                                                        <p><span class="cs-yellow">ROW</span> <strong>02</strong> </p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="cs-card">
                                                        <p><span class="cs-yellow">ROW</span> <strong>03</strong> </p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="cs-card">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                            <div class="ticket-card">
                                ...
                                <div class="ticket-card-3 d-flex">
                                    <div class="cs-left-img">
                                        <figure>
                                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVTZydJcENyxKOvwDeFlSwCeOf_NcHCzd3gw&usqp=CAU" class="img-fluid">
                                        </figure>
                                    </div>
                                    <div class="cs-left">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                            <div class="ticket-card">
                                ...
                                <div class="ticket-card-4 d-flex">
                                    <div class="cs-left" style="background-image: url(https://d1csarkz8obe9u.cloudfront.net/posterpreviews/dark-pink-background-template-design-04eeaaaf9ea63502ddd92ad5e20f8f3e_screen.jpg?ts=1561436711);">
        ...
        <div class="col-lg-12 mb-30">
            <div class="card">
                <div class="card-block">
                    <div class="event-card-head j-c-s-b">
                        <div class="event-card-head-new">
                            <button href="#collapse13" class="nav-toggle cls-hide-show"><i class="fas fa-minus"></i></button>
                            <h3><i class="fas fa-tasks"></i></span> Todo List </h3>
                        </div>
                    </div>
                    <div class="todo-listing-wrap mt-4" id="collapse13" style="display: block;">
                                        ...
                                        <table class="table event-table pending-done-status">
                                            ...
                                            <tr class="{{count( categoryOrders($category->eventCategory->id, $user_event->id) ) > 0 ? 'bg-success' : ''}}">
                                                ...
                                                <td>
                                                    ...
                                                    $disputeEventId = checkEventID($object->id);
