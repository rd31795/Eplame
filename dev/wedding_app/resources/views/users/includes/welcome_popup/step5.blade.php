...
<form id="fiveEventCreate" action="{{url(route('steps.second'))}}">
   ...
   <div class="row">
      ...
      <div class="col-md-6">
         {{choosefile($errors, 'Event Picture* <i class="fas fa-info-circle" data-toggle="tooltip" title="Event Picture!"></i>', 'event_picture')}}
      </div>
      <div class="col-md-12">
         <div class="form-group">
         ...
         <div class="form-group" style="display: none;">
            ...
            <div class="input-field-wrap">
               <select class="form-control" id="template_id" name="template_id">
                  <?php $EventTemplates = \App\EventTemplate::where('user_id',Auth::user()->id)->orderBy('template_name','ASC')->get(); ?>
                  @foreach($EventTemplates as $EventTemplate)
                   <option value="{{$EventTemplate->id}}">{{$EventTemplate->template_name}}</option>
                  @endforeach
                  <!--  <option value="0">Others</option> -->
               </select>
            </div>
      ...
      <div class="col-md-12">
      <div class="form-group">
               <label class="control-label">Souvenir Store <i class="fas fa-info-circle" data-toggle="tooltip" title="" data-original-title="Souvenir Store URL!"></i></label>
               <input type="text" name="souvenir_url" id="souvenir_url" class="form-control valid">
            </div>
      </div>
      <div class="col-md-12" id="table-csv2">
        <!--  <div class="form-group ">  
            ...
            <input name='media' id="media" type='radio' value="zoom" checked/> Zoom <br>
            <input name='media' id="media" type='radio' value="googlemeet" /> Google Meet<br>
            <input name='media' id="media" type='radio' value="arrowchat" /> Arrow Chat<br>
         </div> -->
