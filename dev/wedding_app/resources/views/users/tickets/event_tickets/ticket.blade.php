            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <div id="Ticket1" class="desc">
                        <form method="post" enctype="multipart/form-data" action="{{route('event-ticket-update',$eventTicket->id)}}">
                            @csrf
                                        ...
                                        <div class="row field_wrapper">
                                            <div class="element col-lg-3 col-md-6">
                                                <div class="pick-color-field-wrap">
                                                    <div class="form-group">
                                                        <input type="color" onchange="themecolor(this)" class="ColorGet" id="theme_color_event" style="width: 46px; margin-left: -2px;" name="theme_color" value="{{$eventTicket->theme_color}}"  data-id="event_theme_color" id="side_ticket_color">
                                                         <input type="text" onchange="textThemecolor(this)" id="ticket_theme_color" data-id="event_theme_color" value="{{$eventTicket->theme_color}}" class="form-control ColourSelect" name="colourNames[]" placeholder="Colour Name">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="row field_wrapper">
                                            <div class="element col-lg-3 col-md-6">
                                                <div class="pick-color-field-wrap">
                                                    <div class="form-group">
                                                        <input type="color" onchange="sideTicketColor(this)" id="side_color_event" class="ColorGet" style="width: 46px; margin-left: -2px;" value="{{$eventTicket->ticket_right_side}}" name="ticket_right_side"  data-id="side_ticket_color" id="ticket_side_color">
                                                         <input type="text" onchange="texSideTicketColor(this)" id="ticket_side_color" data-id="event_side_color" value="{{$eventTicket->ticket_right_side}}"  class="form-control ColourSelect" name="colourNames[]" placeholder="Colour Name">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<!--                                     <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control ckeditor" cols="80" id="header-content" name="header_content" rows="10">
                                            {!!$eventTicket->header_content!!}
                                        </textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="row field_wrapper">
                                            <div class="element col-lg-3 col-md-6">
                                                <div class="pick-color-field-wrap">
                                                    <div class="form-group">
                                                        <input type="color" onchange="GetColourName(this)" class="ColorGet" style="width: 46px; margin-left: -2px;" name="colours" value="{{$eventTicket->font_color}}" data-id="event_color_name" id="template_font_color">
                                                        <input type="text" onchange="GetColourName(this)" id="event_color_name" data-id="template_font_color" value="{{$eventTicket->font_color}}" class="form-control ColourSelect" name="colourNames[]" placeholder="Colour Name">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="row field_wrapper">
                                            <div class="element col-lg-3 col-md-6">
                                                <div class="pick-color-field-wrap">
                                                    <div class="form-group">
                                                        <input type="color" onchange="GetColourName(this)" class="ColorGet" style="width: 46px; margin-left: -2px;" name="logocolours" value="{{$eventTicket->logo_color}}" id="template_logo_color" data-id="logo_color_name">
                                                        <input type="text" onchange="GetColourName(this)" data-id="template_logo_color" id="logo_color_name" value="{{$eventTicket->logo_color}}" class="form-control ColourSelect" name="logoColourNames[]" placeholder="Logo Colour Name">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control  custom-file-input2" value="{{$eventTicket->template_text}}" name="template_text" id="template_text">
                                    </div>
                                    @endif
                                </div>
                            </div>
                            <div class="back-section-fields">
                                ...
                                <div id="back_area" class="panel-collapse collapse show">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control  custom-file-input2 ckeditor" name="template_backcover_text" id="template_backcover_text">{{$eventTicket->template_backcover_text}}</textarea>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="row field_wrapper">
                                            <div class="element col-lg-3 col-md-6">
                                                <div class="pick-color-field-wrap">
                                                    <div class="form-group">
                                                        <input type="color" value="{{$eventTicket->back_font_colour}}" onchange="GetColourName(this)" class="ColorGet" style="width: 46px; margin-left: -2px;" name="back_colours" value="#000" data-id="event_back_color_name" id="template_back_font_color">
                                                        <input type="text" onchange="GetColourName(this)" id="event_back_color_name" data-id="template_back_font_color":   value="{{$eventTicket->back_font_colour}}"  class="form-control ColourSelect" name="colourNames[]" placeholder="Back Colour Name">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="back-section-fields">
                                <h4><a data-toggle="collapse" data-parent="#Ticket1" href="#inventory" class="edit-ticket-h4 collapsed"><span class="text-section">Inventory Section</span> <i class="fas fa-angle-down"></i></a></h4>
                                <div id="inventory" class="panel-collapse collapse">
                                    @php 
                                      $registration_type=App\RegistrationType::where('event_id',$eventTicket->event_id)->get();
                                      $counter=0;
                                    @endphp

                                    @foreach($registration_type as $key=>$reg)
                                       <div class="registration_type_heading">
                                        <h5 style="text-transform: uppercase;">{{$reg->reg_type}} Ticket</h5>
                                       </div>
                                       <div class="form-group">
                                         <label for="quantity_{{$key}}">Number of tickets a single user can buy at a time</label>
                                         <input type="number" id="quantity_{{$key}}" value="{{$reg->inventory}}"  class="form-control" name="quantity_{{$key}}" min="1" max="{{$reg->seats}}">
                                       </div>
                                       <div class="form-group">
                                          <label for="price_{{$key}}">Ticket Price</label>
                                          <input type="number"  id="price_{{$key}}" name="price_{{$key}}" class="form-control"  value="{{$reg->price}}">    
                                       </div>
                                       <div class="form-group">
                                          <label for="discription_{{$key}}">Discription</label>
                                          <textarea id="discription_{{$key}}" name="description_{{$key}}" class="form-control" value="{{$reg->description}}">{{$reg->description}}</textarea>
                                       </div>
                                       <input type="hidden" name="inventory_id_{{$key}}"  value="{{$reg->id}}">
                                      @php
                                        $counter++;
                                      @endphp
                                    @endforeach
                                    <input type="hidden" name="inventory_country" value="{{$counter}}">
                                </div>
                            </div>
...
function themecolor(e){
  ...
  $("#ticket_theme_color").val(e.value);
...
function sideTicketColor(e){
   ...
   $("#ticket_side_color").val(e.value);
}

function textThemecolor(e){
  $("#theme_color_event").val(e.value);
   $(".theme-color-header").attr('style',`background-color:${e.value}b3;`);
    $('.border_color_theme').attr('style',`border-color:${e.value}`);
      $(".theme-color").attr('style',`background-color:${e.value}`);
}

function texSideTicketColor(e){
   $("#side_color_event").val(e.value);
  $("#ticket-right-side").attr('style',`background-color:${e.value}`);
}
</script>
<script>
