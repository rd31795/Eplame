...
<div class="container-fluid">
    <div class="row">
       ...
       <div class="card-header"><h3>PROFILE SETTINGS</h3>
       <form method="post" action="{{route('vendor_profile_deactivation')}}" >
  @csrf
  <button type="submit" class="btn btn-primary deactive-button" ><?= Auth::User()->user_active == 0 ? 'Activate' : 'Deactivate' ?></button>
</form></div>
           <div class="card-body">
