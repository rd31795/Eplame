...
@section(Config::get('chatter.yields.head'))
    <link href="{{ url('/wedding_app/vendor/devdojo/chatter/public/assets/vendor/spectrum/spectrum.css') }}" rel="stylesheet">
	<link href="{{ url('/wedding_app/vendor/devdojo/chatter/public/assets/css/chatter.css') }}" rel="stylesheet">
	@if($chatter_editor == 'simplemde')
		<link href="{{ url('/wedding_app/vendor/devdojo/chatter/public/assets/css/simplemde.min.css') }}" rel="stylesheet">
	@elseif($chatter_editor == 'trumbowyg')
		<link href="{{ url('/wedding_app/vendor/devdojo/chatter/public/assets/vendor/trumbowyg/ui/trumbowyg.css') }}" rel="stylesheet">
		<style>
...
@if( $chatter_editor == 'tinymce' || empty($chatter_editor) )
	<script src="{{ url('/wedding_app/vendor/devdojo/chatter/public/assets/vendor/tinymce/tinymce.min.js') }}"></script>
	<script src="{{ url('/wedding_app/vendor/devdojo/chatter/public/assets/js/tinymce.js') }}"></script>
	<script>
...
@elseif($chatter_editor == 'simplemde')
	<script src="{{ url('/wedding_app/vendor/devdojo/chatter/public/assets/js/simplemde.min.js') }}"></script>
	<script src="{{ url('/wedding_app/vendor/devdojo/chatter/public/assets/js/chatter_simplemde.js') }}"></script>
@elseif($chatter_editor == 'trumbowyg')
	<script src="{{ url('/wedding_app/vendor/devdojo/chatter/public/assets/vendor/trumbowyg/trumbowyg.min.js') }}"></script>
	<script src="{{ url('/wedding_app/vendor/devdojo/chatter/public/assets/vendor/trumbowyg/plugins/preformatted/trumbowyg.preformatted.min.js') }}"></script>
	<script src="{{ url('/wedding_app/vendor/devdojo/chatter/public/assets/js/trumbowyg.js') }}"></script>
@endif

<script src="{{ url('/wedding_app/vendor/devdojo/chatter/public/assets/vendor/spectrum/spectrum.js') }}"></script>
<script src="{{ url('/wedding_app/vendor/devdojo/chatter/public/assets/js/chatter.js') }}"></script>
<script>
	$('document').ready(function(){
