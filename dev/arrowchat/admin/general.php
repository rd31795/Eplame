				...
				if (empty($error))
				{
					$result = $db->execute("
						...
						SET config_value = CASE 
							...
							WHEN config_name = 'mobile_background_color' THEN '" . get_var('mobile_background_color') . "'
							WHEN config_name = 'mobile_icon_color' THEN '" . get_var('mobile_icon_color') . "'
					...
					if ($result) 
					{
						...
						$mobile_background_color = get_var('mobile_background_color');
						$mobile_icon_color = get_var('mobile_icon_color');
