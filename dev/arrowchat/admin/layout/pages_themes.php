...
?>
						<li class="listItem">
							...
							<a href="themes.php?do=managethemes&activate=<?php echo $row['active']; ?>&id=<?php echo $row['id']; ?>&token=<?php echo $token; ?>" title="<?php if ($row['active']==1) echo "Visible"; else echo "Hidden"; ?>" class="secondaryContent <?php if ($row['active']==1) echo "deactivate"; else echo "activate"; ?>"><span>Deactivate</span></a>
