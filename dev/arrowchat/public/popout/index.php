		...
		<div id="arrowchat_popout_left">
			<div id="arrowchat_popout_friends">
				...
				<div id="arrowchat_popout_selection_wrapper">
					<div id="arrowchat_popout_selection_chat" class="arrowchat_popout_selection_box arrowchat_popout_selection_focused"><?php echo $language[295]; ?></div>
					<div id="arrowchat_popout_selection_room" class="arrowchat_popout_selection_box"><?php echo $language[296]; ?></div>
				</div>
