<?php 
	...
	*/
	...
	include_once( dirname(dirname(dirname(__FILE__))).DIRECTORY_SEPARATOR.'wedding_app'.DIRECTORY_SEPARATOR.'vendor'.DIRECTORY_SEPARATOR.'autoload.php');
	include_once( dirname(dirname(dirname(__FILE__))).DIRECTORY_SEPARATOR.'wedding_app'.DIRECTORY_SEPARATOR.'bootstrap'.DIRECTORY_SEPARATOR.'app.php');
	...
	*/
	...
	define('DB_PASSWORD','GD!2#hldGHSukj'); 
	define('DB_NAME','weddingwire');	
	...
	*/
	...
	define('DB_USERTABLE_AVATAR','profile_image'); 
