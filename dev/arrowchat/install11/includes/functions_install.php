	...
	*/
	function getFinalInstructions($version) 
	{
		switch($version)
		{
			...
			case "buddyboss_v1":
				return "In BuddyBoss, you can edit the header and footer files by going to the WordPress Admin Panel > Appearance > Editor > Edit the Header and Footer files (usually header.php and footer.php) of your active theme.";
				break;
			...
			case "flarum_v1":
				return "In Flarum, you can edit the header and footer files by going to the Flarum Admin Panel, clicking Appearance and then editing the custom header and custom footer.";
				break;
			...
			case "phpfox_v4.2":
				return "In phpFox, you can change the header and footer by logging in to the phpFox admin dashboard > Appearance > Themes > Mouse over your active theme and click Edit > Click HTML on the side bar.  Be sure that you put the code after the &lt;head&gt; tag and before the &lt;/body&gt; tag then click save.  You may also need to clear the cache by going to Maintenance > Cache Manager > Click the Clear Cache button.";
				break;
			...
			case "datingpro_v1":
				return "In Dating Pro, you can edit the header and footer files by going to the following folder: /application/views/default/.  Then, edit the header.tpl and footer.tpl files.  Be sure that you put the code after the &lt;head&gt; tag and before the &lt;/body&gt; tag.  You can do ctrl+F to find these in the file.";
				break;
				
			case "datingpro_v2020":
				return "In Dating Pro, you can edit the header and footer files by going to the following folder: /application/views/{your theme's name}/.  Then, edit the header.twig and footer.twig files.  Be sure that you put the code after the &lt;head&gt; tag and before the &lt;/body&gt; tag.  You can do ctrl+F to find these in the file.";
				break;
